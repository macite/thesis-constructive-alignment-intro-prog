...
\begin{itemize}[noitemsep,nolistsep]
	...
	\item Criteria for grades higher than Pass required student to demonstrate deeper understanding of the concepts related to the intended learning outcomes. (\acref{ac-grades})
