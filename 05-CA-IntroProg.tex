...
\begin{itemize}[noitemsep,nolistsep]
	...
	\item Each grade required students to demonstrate understanding across all outcomes. (\Pref{itm:align})
	\item The criteria determined each student's final grade, delaying all summative assessment until the end of the unit. (\Pref{itm:formative})
	\item Different levels in the assessment criteria focused on addressing the most important aspects for students to focus on, while they are working on completing tasks for that grade outcome. (\Pref{itm:focus})
