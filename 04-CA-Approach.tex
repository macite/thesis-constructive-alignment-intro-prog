...
\begin{figure}[htbp]
	...
	\caption{The five levels of the SOLO taxonomy, used to help define the intended learning outcomes and assessment criteria, adopted from \citet{Biggs:2007}.}
	\label{fig:solo}
\end{figure}
...
\begin{table}
	...
	\centering
	\caption{Select list of verb related to the various levels of the SOLO Taxonomy, adopted from \citet{Biggs:2007}}
