...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{OverallStrategy}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.65\textwidth]{DefiningILOs}
...
Based on our experience we suggest the following guidelines be used to guide the creation and assessment activities of portfolios:
