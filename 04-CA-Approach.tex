...
\begin{itemize}
	\item Students construct their knowledge in response to activity (constructivism).
	...
	\item Ensure step of the learning process should present students with a coherent set of concepts. 
	% Avoid using concepts before they are explained, thereby ensuring each step of the learning process provides students with a coherent model.
