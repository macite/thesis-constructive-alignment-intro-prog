...
The resources in this chapter are divided into tools to support both \emph{how} and \emph{what} we taught. \sref{sec:doubtfire} describes an online tool used to support the teaching and learning environment, providing support for \emph{how} the units were taught. \sref{sec:arcana}, \sref{sec:vodcasts} and \sref{sec:swingame} describe three different resources used to support \emph{what} we taught. \sref{sec:arcana} describes the creation of a concept-based text to support the procedures first approach.This text was supported by a series of video podcasts, which are outlined in \sref{sec:vodcasts}. \sref{sec:swingame} describes a game development framework used to enable students to create more engaging programs.
