...
The use of the approach from \cref{cha:approach} could provide a means of assessing learning outcomes for students in units that include significant use of group work, such as with team-based final year capstone projects. The focus on assessing learning outcomes (\Pref{itm:formative}) over assessing product outcomes, and the portfolio's focus on student's demonstrating how they have met the unit's intended learning outcomes, provide a means of assessing individuals.
...
\section{Approach in Relation to Prior Work on Constructive Alignment} % (fold)
