...
\cref{cha:example_impl} described two programming units implemented using the approach described in \cref{cha:approach}, and principles stated in \cref{cha:guiding_principles}. These units adopted an objects-later approach to introductory programming by starting with a procedural programming unit, followed by an object oriented programming unit.
